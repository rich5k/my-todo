    ...
    return ( 
        <div className="Comment">
            ...
            <form action="" className={isHidden ? "add-comment grid grid-cols-4 hidden" : "add-comment grid grid-cols-2"}>
                ...
                <div>
                    <button disabled={!message} type="submit" onClick={handleSubmit} class=" text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">update</button>
                </div>
            </form>}
